...
Exclusions via `6_quality.modules.exclusions` (`tk-*` prefixes + `suspicious_sets`). Listed in `analysis_summary.json` → `excluded_set_ids`. Cross-sectional methodology (same market snapshot, different release years).
